...
def add_train_parser(sub: argparse._SubParsersAction) -> None:
    ...
    p.add_argument("--features", type=str, default="CTh,K1,K2", help="comma list of feature channels to train: CTh, K1, K2. Use --features CTh for CTh-only.")
    p.add_argument("--channel_loss_weights", type=str, default="", help="optional comma weights matching --features, e.g. '1,0.2,0.2'")
